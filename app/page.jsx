...
export default function Home() {
  return (
    <div>
      ...
      <HeroSection />
      <section className={"w-full py-12 md:py-24 lg:py-32 bg-background mt-10"}>
        <div className={"container mx-auto px-4 md:px-6"}>
          ...
          <div
            className={
              "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto"
            }
          >
                    ...
                    <div className={"flex flex-col space-y-4"}>
                      ...
                      <blockquote>
                        <p className={"text-muted-foreground italic relative"}>
                          <span
                            className={
                              "text-3xl text-primary absolute -top-4 -left-2"
                            }
                          >
                            &quot;
                          </span>
      ...
      <section className={"w-full"}>
        <div className={"mx-auto py-24 rounded-lg gradient"}>
          <div
            className={
              "flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto"
            }
          >
            <h2
              className={
            ...
            <p
              className={
                "text-primary-foreground/80 mx-auto max-w-[600px] md:text-xl"
              }
            >
